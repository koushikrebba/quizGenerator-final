...
async function run(theme) {
    ...
    const prompt = `Create a quiz based on ${theme} with 5 questions. Each question should have 4 options: 1 correct answer and 3 incorrect answers. Provide the quiz in a plain JSON format with no additional text or markdown. The JSON should have the following structure:
            ...
            Please make sure the response only includes the JSON object as shown above, without any additional text or formatting.`;
